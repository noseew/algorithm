package org.song.algorithm.algorithmbase._01datatype._01base._01linear.bit._03app.bitmap;
...
public class BitMap_base_03_bloomfilter {
    ...
    布隆过滤器
        ...
        布隆过滤器如何存储数据?
            存储一个数据k
                使用 hash1 => code1 然后存入 bitmap
                使用 hash2 => code2 然后存入 bitmap
                使用 hash_n => code_n 然后存入 bitmap
