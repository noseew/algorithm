package org.song.algorithm.algorithmbase._01datatype._03app.geo.geohash.testcase;
...
/**
 * @description: 算法参考地址: https://www.jianshu.com/p/7332dcb978b2
 * 代码参考地址: https://blog.csdn.net/xiaojimanman/article/details/50358506
 * @author: jiali.song@song.com
 * @date: 2019年02月02日 11:01:24
 **/
public class GeoHashDemo {
    ...
    /**
     * latLength 等级 和 实际距离的关系
     * <p>
     * 字符串长度(等级) cell 宽度 cell 高度
     * 1 ≤ 5,000km * 5,000km
     * 2 ≤ 1,250km * 625km
     * 3 ≤ 156km * 156km
     * 4 ≤ 39.1km * 19.5km
     ...
     *
     * @Author:lulei
     * @Description: 设置经纬度的最小单位, 根据 latLength 等级
     */
     ...
     * @return
     * @Author:lulei
     * @Description: 设置经纬度转化为geohash长度, 重新自定义 区分等级
     */
    ...
    /**
     * 经纬度合并 示意图 <img src='org/song/algorithm/hexagon/geohash/geohash-经纬度合并.png'></>
     * <p>
     * 精度误差的问题
     ...
     * @return
     * @Author:lulei
     * @Description: 合并经纬度二进制 规则 偶数位放经度，奇数位放纬度
     */
