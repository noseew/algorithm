...
public class SkipList02Test {
    ...
    public void test01() {
        ...
        SkipListLinked03Rank<Integer, Integer> skip1 = new SkipListLinked03Rank<>();
    ...
    public void testAuto01() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ArrayBase01<SkipListLinked03Rank.Node<Integer, Integer>> byScore = skip1.getNodesByScore(-1, -1);
            ...
            for (int j = 0; j < maxSize; j++) {
                ...
                ArrayBase01<SkipListLinked03Rank.Node<Integer, Integer>> nodes = skip1.getNodesByScore(score, score + 1);
                boolean noHas = true;
