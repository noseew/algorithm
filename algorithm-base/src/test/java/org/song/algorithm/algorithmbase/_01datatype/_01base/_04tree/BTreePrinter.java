...
import org.song.algorithm.algorithmbase._01datatype._01base._04tree.model.TreeNode;
...
//                System.out.print(node.v + " " + node.height);
    ...
    */
    ...
    private static void writeArray(TreeNode currNode, int rowIndex, int columnIndex, String[][] res, int treeDepth) {
        ...
        // 先将当前节点保存到二维数组中
        res[rowIndex][columnIndex] = String.valueOf(currNode.v);
