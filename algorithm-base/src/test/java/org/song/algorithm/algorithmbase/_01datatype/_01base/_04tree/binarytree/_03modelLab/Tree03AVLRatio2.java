...
public class Tree03AVLRatio2<V extends Comparable<V>> extends Tree03AVLRatio1<V> {
    ...
    public Tree03AVLRatio2(Comparator<V> comparator) {
        super(comparator);
    }

    protected boolean higher(TreeNode<V> node1, TreeNode<V> node2) {
        int node1Height = Tree02BST01.getHeight(node1);
        int node2Height = Tree02BST01.getHeight(node2);
