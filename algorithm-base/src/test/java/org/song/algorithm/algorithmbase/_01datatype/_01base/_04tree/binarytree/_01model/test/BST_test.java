...
import org.song.algorithm.algorithmbase._01datatype._01base._04tree.binarytree._01model.Tree02BST01;
import org.song.algorithm.algorithmbase._01datatype._01base._04tree.binarytree._01model.Tree02BST03;
import org.song.algorithm.algorithmbase._01datatype._01base._04tree.binarytree.printer.BTreeUtils;
import org.song.algorithm.algorithmbase._01datatype._01base._04tree.binarytree._01model.AbsBSTTree;
...
//        Tree02BST02<Integer> tree = new Tree02BST02<>(Comparator.comparing(Integer::doubleValue));
        Tree02BST03<Integer> tree = new Tree02BST03<>(Comparator.comparing(Integer::doubleValue));
        tree.add(55);
        tree.add(38);
        tree.add(76);
        tree.add(25);
