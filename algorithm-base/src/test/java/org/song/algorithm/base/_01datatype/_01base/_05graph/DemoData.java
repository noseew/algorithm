...
public class DemoData {
    static IGraph.EdgeOpr<Double> weightManager = new IGraph.EdgeOpr<Double>() {
     ...
     * @return
     */
    public static IGraph<Object, Double> undirectedGraph(Object[][] data) {
        IGraph<Object, Double> graph = new AdjacencyList<>(weightManager);
